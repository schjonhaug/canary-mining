...
impl HandleTemplateDistributionMessagesFromServerAsync for ChannelManager {
    ...
    async fn handle_new_template(
        ...
        info!(
            ...
            future_template = msg.future_template,
            merkle_path_len = msg.merkle_path.0.len(),
            coinbase_tx_value_remaining = msg.coinbase_tx_value_remaining,
            "Received NewTemplate"
        );

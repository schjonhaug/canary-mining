...
use bitcoin_core_sv2::{
    template_distribution_protocol::{BitcoinCoreSv2TDP, CancellationToken},
...
pub struct BitcoinCoreSv2TDPConfig {
    ...
    pub template_runtime_status: TemplateRuntimeStatus,
    ...
    std::thread::spawn(move || {
        ...
        tokio_local_set.block_on(&rt, async move {
            ...
            let mut sv2_bitcoin_core = match BitcoinCoreSv2TDP::new(
                ...
                bitcoin_core_config.template_runtime_status.clone(),
